				...
				<div className="row justify-content-center">
					<div className="col-lg-8">
						<p className="lead text-muted">
							...
							bringing my imagination to fruition. I work with Unity and C# for
							game development, and I also build web applications with React,
							JS/TS, and Supabase. I particularly enjoy the feeling after
							solving a tough problem after hours (and sometimes even days) of
							debugging and scratching my head. Game development has taught me
