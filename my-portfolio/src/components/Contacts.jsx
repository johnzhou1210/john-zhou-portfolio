        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <p className="lead text-muted">
              ...
              with React, JS/TS, and Supabase. I particularly enjoy the feeling
              after solving a tough problem after hours (and sometimes even
              days) of debugging and scratching my head. Game development has
              taught me about the neverending process of learning and applying
              new skills.
            </p>
